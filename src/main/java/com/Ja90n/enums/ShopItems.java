...
public enum ShopItems {
    ...
    WOOD(ItemStack.builder(Material.SPRUCE_PLANKS).displayName(Component.text("Wood",NamedTextColor.GOLD)).amount(3).build(),Cost.SALMON,2),
    ...
    SHEARS(ItemStack.builder(Material.SHEARS).displayName(Component.text("Shears")).build(),Cost.COD,5);
